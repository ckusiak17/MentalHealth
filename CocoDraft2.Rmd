...
save(auc.test.lasso, auc.test.ridge, auc.test.aic, file = "try2_validation_aucs.Rda")
```
...
save(auc10_lasso, auc10_ridge, auc10_aic, file = "try2_performance_aucs.Rda")
```
...
save(auc1000_lasso, auc1000_ridge, auc1000_aic, file = "try2_performance_aucs_bigger.Rda")
```
