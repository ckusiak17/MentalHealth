...
load("mhfp2.Rda")
mhfp<-bstat743fp
mhfp <- subset(mhfp, select=-c(QLMENTL2, `_LLCPWT`))
...
mhfp$sexorient<-as.numeric(as.factor(mhfp$sexorient))
```  
...
imputedat<-mice(mhfp, m=10, maxit = 20, method = 'sample', seed = 500)
summary(imputedat)
...
mental: Felt stress, poor mental health, or depression symptoms in the last 30 days (binary)
