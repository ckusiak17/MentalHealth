...
##Complete Case Model##
fit.cc<-glm(formula=mental~state + sleep + male + employ + actlimit + metro + exer30 + race + income + smoker + binge, family="binomial", data=mhfp)
...
##20 iterations##
imputedatval<-mice(randodat, m=10, maxit = 20, method = 'sample', seed = 500, print=FALSE)
...
##50 iterations##
imputedat50val<-mice(randodat, m=10, maxit = 50, method = 'sample', seed = 500, print=FALSE)
...
##Complete Case Model##
fit.ccval<-glm(formula=mental~state + sleep + male + employ + actlimit + metro + exer30 + race + income + smoker + binge, family="binomial", data=randodat)
#str(imputedat$imp$sexorient)
completedatfitval = complete(imputedatval, action="long") 
head(completedatfitval)
##Pooled Imputed Model##
mi.fitval=glm.mids(mental~state + sleep + male + employ + actlimit + metro + exer30 + race + income + smoker + binge, family="binomial", data=imputedatval)
head(summary(mi.fitval))
comb.test = pool(mi.fitval)
##Summary Table##
print(xtable(summary(comb.test)[,c("est","se","fmi")]))
```
...
str(imputedatval$imp$sexorient)
completedatfit50val = complete(imputedat50val, action="long") 
head(completedatfit50val)
##Pooled Imputed Model##
mi.fit50val=glm.mids(mental~state + sleep + male + employ + actlimit + metro + exer30 + race + income + smoker + binge, family="binomial", data=imputedat50val)
