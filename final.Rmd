...
mi.fit=glm.mids(mental~as.factor(state) + sleep + male + as.factor(employ) + actlimit + as.factor(metro) + exer30 + race + as.factor(income) + as.factor(smoker) + binge, family="binomial", data=imputedat)
head(summary(mi.fit))
